# The name of this view in Looker is "Stock Quant"
view: stock_quant {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sitagaki-odoo.public.stock_quant`
    ;;
  drill_fields: [id]
  ...
  dimension: inventory_diff_quantity {
    type: string
    sql: ${TABLE}.inventory_diff_quantity ;;
  }
  ...
  dimension: inventory_quantity_set {
    type: yesno
    sql: ${TABLE}.inventory_quantity_set ;;
  }
