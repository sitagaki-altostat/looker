# The name of this view in Looker is "Stock Immediate Transfer Line"
view: stock_immediate_transfer_line {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sitagaki-odoo.public.stock_immediate_transfer_line`
    ;;
  drill_fields: [id]
  ...
  dimension: immediate_transfer_id {
    type: number
    sql: ${TABLE}.immediate_transfer_id ;;
  }
  ...
  dimension: to_immediate {
    type: yesno
    sql: ${TABLE}.to_immediate ;;
  }
