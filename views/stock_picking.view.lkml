# The name of this view in Looker is "Stock Picking"
view: stock_picking {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sitagaki-odoo.public.stock_picking`
    ;;
  drill_fields: [id]
  ...
  # This dimension will be called "Backorder ID" in Explore.

  dimension: backorder_id {
    type: number
    sql: ${TABLE}.backorder_id ;;
  }
  ...
  dimension: has_deadline_issue {
    type: yesno
    sql: ${TABLE}.has_deadline_issue ;;
  }

  dimension: immediate_transfer {
    type: yesno
    sql: ${TABLE}.immediate_transfer ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [id, name, stock_picking_transfer_rel.count]
  }
}
