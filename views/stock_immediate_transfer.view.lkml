# The name of this view in Looker is "Stock Immediate Transfer"
view: stock_immediate_transfer {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sitagaki-odoo.public.stock_immediate_transfer`
    ;;
  drill_fields: [id]
  ...
  dimension: show_transfers {
    type: yesno
    sql: ${TABLE}.show_transfers ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [id, stock_picking_transfer_rel.count]
  }
}
