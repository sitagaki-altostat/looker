# The name of this view in Looker is "Gamification Karma Tracking"
view: gamification_karma_tracking {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sitagaki-odoo.public.gamification_karma_tracking`
    ;;
  drill_fields: [id]
  ...
  # This dimension will be called "Consolidated" in Explore.

  dimension: consolidated {
    type: yesno
    sql: ${TABLE}.consolidated ;;
  }
