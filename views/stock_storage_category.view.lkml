# The name of this view in Looker is "Stock Storage Category"
view: stock_storage_category {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sitagaki-odoo.public.stock_storage_category`
    ;;
  drill_fields: [id]
  ...
  # This dimension will be called "Allow New Product" in Explore.

  dimension: allow_new_product {
    type: string
    sql: ${TABLE}.allow_new_product ;;
  }
