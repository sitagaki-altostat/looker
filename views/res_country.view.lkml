# The name of this view in Looker is "Res Country"
view: res_country {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sitagaki-odoo.public.res_country`
    ;;
  drill_fields: [id]
  ...
  dimension: address_view_id {
    type: number
    sql: ${TABLE}.address_view_id ;;
  }
  ...
  dimension: state_required {
    type: yesno
    sql: ${TABLE}.state_required ;;
  }
  ...
  dimension: zip_required {
    type: yesno
    sql: ${TABLE}.zip_required ;;
  }

  measure: count {
    type: count
    drill_fields: [id, name, res_country_res_country_group_rel.count]
  }
}
