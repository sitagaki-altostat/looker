# The name of this view in Looker is "Ir Property"
view: ir_property {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sitagaki-odoo.public.ir_property`
    ;;
  drill_fields: [id]
  ...
  dimension: value_float {
    type: number
    sql: ${TABLE}.value_float ;;
  }

  dimension: value_integer {
    type: number
    sql: ${TABLE}.value_integer ;;
  }

  dimension: value_reference {
    type: string
    sql: ${TABLE}.value_reference ;;
  }

  dimension: value_text {
    type: string
    sql: ${TABLE}.value_text ;;
  }
