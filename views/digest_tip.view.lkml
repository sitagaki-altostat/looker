# The name of this view in Looker is "Digest Tip"
view: digest_tip {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sitagaki-odoo.public.digest_tip`
    ;;
  drill_fields: [id]
  ...
  dimension: tip_description {
    type: string
    sql: ${TABLE}.tip_description ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [id, name, digest_tip_res_users_rel.count]
  }
}
