# The name of this view in Looker is "Product Attribute"
view: product_attribute {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sitagaki-odoo.public.product_attribute`
    ;;
  drill_fields: [id]
  ...
  dimension: create_variant {
    type: string
    sql: ${TABLE}.create_variant ;;
  }
