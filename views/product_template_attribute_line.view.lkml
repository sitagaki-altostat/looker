# The name of this view in Looker is "Product Template Attribute Line"
view: product_template_attribute_line {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sitagaki-odoo.public.product_template_attribute_line`
    ;;
  drill_fields: [id]
  ...
  measure: count {
    type: count
    drill_fields: [id, product_attribute_value_product_template_attribute_line_rel.count]
  }
}
