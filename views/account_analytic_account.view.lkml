# The name of this view in Looker is "Account Analytic Account"
view: account_analytic_account {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sitagaki-odoo.public.account_analytic_account`
    ;;
  drill_fields: [id]
  ...
  dimension: root_plan_id {
    type: number
    sql: ${TABLE}.root_plan_id ;;
  }
