# The name of this view in Looker is "Resource Calendar"
view: resource_calendar {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sitagaki-odoo.public.resource_calendar`
    ;;
  drill_fields: [id]
  ...
  dimension: two_weeks_calendar {
    type: yesno
    sql: ${TABLE}.two_weeks_calendar ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [id, name, hr_employee.count, res_company.count]
  }
}
