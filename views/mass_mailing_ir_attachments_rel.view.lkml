# The name of this view in Looker is "Mass Mailing Ir Attachments Rel"
view: mass_mailing_ir_attachments_rel {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sitagaki-odoo.public.mass_mailing_ir_attachments_rel`
    ;;
  ...
  # This dimension will be called "Attachment ID" in Explore.
