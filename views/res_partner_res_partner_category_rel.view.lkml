# The name of this view in Looker is "Res Partner Res Partner Category Rel"
view: res_partner_res_partner_category_rel {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sitagaki-odoo.public.res_partner_res_partner_category_rel`
    ;;
