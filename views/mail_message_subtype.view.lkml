# The name of this view in Looker is "Mail Message Subtype"
view: mail_message_subtype {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sitagaki-odoo.public.mail_message_subtype`
    ;;
  drill_fields: [id]
  ...
  dimension: track_recipients {
    type: yesno
    sql: ${TABLE}.track_recipients ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [id, name, mail_followers_mail_message_subtype_rel.count]
  }
}
