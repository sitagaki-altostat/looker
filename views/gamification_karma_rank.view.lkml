# The name of this view in Looker is "Gamification Karma Rank"
view: gamification_karma_rank {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sitagaki-odoo.public.gamification_karma_rank`
    ;;
  drill_fields: [id]
  ...
  dimension: description_motivational {
    type: string
    sql: ${TABLE}.description_motivational ;;
  }
