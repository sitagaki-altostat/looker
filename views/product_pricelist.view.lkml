# The name of this view in Looker is "Product Pricelist"
view: product_pricelist {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sitagaki-odoo.public.product_pricelist`
    ;;
  drill_fields: [id]
  ...
  dimension: discount_policy {
    type: string
    sql: ${TABLE}.discount_policy ;;
  }
