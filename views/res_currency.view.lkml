# The name of this view in Looker is "Res Currency"
view: res_currency {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sitagaki-odoo.public.res_currency`
    ;;
  drill_fields: [id]
  ...
  dimension: currency_subunit_label {
    type: string
    sql: ${TABLE}.currency_subunit_label ;;
  }

  dimension: currency_unit_label {
    type: string
    sql: ${TABLE}.currency_unit_label ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [id, full_name, name]
  }
}
