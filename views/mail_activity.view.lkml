# The name of this view in Looker is "Mail Activity"
view: mail_activity {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sitagaki-odoo.public.mail_activity`
    ;;
  drill_fields: [id]
  ...
  # This dimension will be called "Activity Type ID" in Explore.
  ...
  dimension: recommended_activity_type_id {
    type: number
    sql: ${TABLE}.recommended_activity_type_id ;;
  }

  dimension: request_partner_id {
    type: number
    sql: ${TABLE}.request_partner_id ;;
  }
