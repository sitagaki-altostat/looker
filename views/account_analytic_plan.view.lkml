# The name of this view in Looker is "Account Analytic Plan"
view: account_analytic_plan {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sitagaki-odoo.public.account_analytic_plan`
    ;;
  drill_fields: [id]
  ...
  dimension: default_applicability {
    type: string
    sql: ${TABLE}.default_applicability ;;
  }
