# The name of this view in Looker is "Mail Channel"
view: mail_channel {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sitagaki-odoo.public.mail_channel`
    ;;
  drill_fields: [id]
  ...
  dimension: default_display_mode {
    type: string
    sql: ${TABLE}.default_display_mode ;;
  }
  ...
  dimension: group_public_id {
    type: number
    sql: ${TABLE}.group_public_id ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [id, name, mail_channel_res_groups_rel.count]
  }
}
