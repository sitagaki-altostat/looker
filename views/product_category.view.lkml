...
view: product_category {
  ...
  sql_table_name: `sitagaki-odoo.public.product_category`
    ;;
  drill_fields: [id]
  ...
  # This dimension will be called "Complete Name" in Explore.
  ...
  dimension: packaging_reserve_method {
    type: string
    sql: ${TABLE}.packaging_reserve_method ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [id, complete_name, name, stock_warehouse_orderpoint.count]
  }
}
