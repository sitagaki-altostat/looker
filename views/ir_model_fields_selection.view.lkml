# The name of this view in Looker is "Ir Model Fields Selection"
view: ir_model_fields_selection {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sitagaki-odoo.public.ir_model_fields_selection`
    ;;
  drill_fields: [id]
